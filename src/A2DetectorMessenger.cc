...
{ 
  ...
  fUsePIDCmd->AvailableForStates(G4State_PreInit,G4State_Init,G4State_Idle);
  ...
  fTargetZ0Cmd->AvailableForStates(G4State_PreInit,G4State_Init,G4State_Idle);
  ...
  fUpdateCmd->AvailableForStates(G4State_Init,G4State_Idle);
